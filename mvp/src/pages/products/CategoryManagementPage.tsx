    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        <CategoryQuickActions
          onAddCategory={() => handleQuickAction('add-product')}
          onImportCategories={() => handleQuickAction('import')}
          onExportCategories={() => handleQuickAction('export')}
          onPrintCategories={() => handleQuickAction('print')}
          onSearchCategories={() => handleQuickAction('search')}
        />
      </div>
