          ...
          <div className="space-y-4">
            <div>
              <div className="relative group">
                ...
                />
                <label htmlFor="emailOrUsername" className="pointer-events-none absolute right-12 top-1/2 -translate-y-1/2 bg-transparent px-1 text-sm text-gray-500 transition-all duration-200 peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-gray-500 peer-focus:-top-2 peer-focus:bg-white peer-focus:text-xs peer-focus:text-blue-600 dark:peer-focus:bg-gray-900">
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  aria-describedby={error ? 'login-error' : undefined}
                />
                <label htmlFor="password" className="pointer-events-none absolute right-12 top-1/2 -translate-y-1/2 bg-transparent px-1 text-sm text-gray-500 transition-all duration-200 peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-gray-500 peer-focus:-top-2 peer-focus:bg-white peer-focus:text-xs peer-focus:text-blue-600 dark:peer-focus:bg-gray-900">
                  {AR_LABELS.password}
                </label>
                <button
                  type="button"
