...
import { ProfileFormFields } from '@/shared/types'; // ProfileFormFields is now correctly imported
import { AR_LABELS, ChevronDownIcon } from '@/shared/constants';
  ...
  return (
    <div className="bg-white rounded-lg shadow-xl p-6 flex-grow">
      ...
      <div className="border-b border-gray-200 mb-6">
        <nav className="-mb-px w-full overflow-x-auto scroll-smooth horizontal-nav-scroll">
          <div className="flex space-x-4 space-x-reverse min-w-max pb-2">
            {tabs.map((tab) => (
              <button
                key={tab.id}
