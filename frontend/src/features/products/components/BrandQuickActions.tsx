...
const BrandQuickActions: React.FC<BrandQuickActionsProps> = ({
  onAddBrand,
  onImportBrands,
  onExportBrands,
  onPrintBrands,
  ...
  const quickActions = [
    ...
    {
      id: 3,
      title: 'تصدير العلامات التجارية',
      icon: <ExportIcon />,
      colorClass: 'bg-green-500 hover:bg-green-600 text-white',
      onClick: onExportBrands
    },
    {
      id: 4,
      title: 'طباعة العلامات التجارية',
      icon: <PrintIcon />,
      colorClass: 'bg-purple-500 hover:bg-purple-600 text-white',
      onClick: onPrintBrands
    },
    {
      id: 5,
      title: 'البحث المتقدم',
      ...
      onClick: onSearchBrands
    }
  ];

  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
      <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">الإجراءات السريعة للعلامات التجارية</h3>
...
export default BrandQuickActions;
