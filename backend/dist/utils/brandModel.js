...
var brandModel_exports = {};
__export(brandModel_exports, {
  getBrandModel: () => getBrandModel,
  getBrandModelForStore: () => getBrandModelForStore,
  getStorePrefix: () => getStorePrefix
});
module.exports = __toCommonJS(brandModel_exports);
var import_mongoose = __toESM(require("mongoose"));
var import_Store = __toESM(require("../models/Store"));
var import_databaseManager = require("./databaseManager");
const brandSchema = new import_mongoose.Schema(
  {
    name: {
      type: String,
...
async function getBrandModel(prefix, databaseId) {
  if (!prefix) {
    ...
    return import_mongoose.default.model(defaultCollectionName, brandSchema, defaultCollectionName);
  }
  ...
  return connection.model(collectionName, brandSchema, collectionName);
}
