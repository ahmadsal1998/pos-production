...
function getBusinessDateFilterRange(startDate, endDate, businessDayStartTime, timezone) {
    ...
    if (!timezone) {
        logger_1.log.warn('[BusinessDate] No timezone provided for date filtering, defaulting to UTC. This may cause incorrect business day calculations.', {
            startDate,
            endDate,
    ...
    if (startDate) {
        ...
        if (start) {
            logger_1.log.debug('[BusinessDate] Start date calculation', {
    ...
    if (endDate) {
        ...
        // Log detailed calculation for debugging
        if (end) {
            logger_1.log.debug('[BusinessDate] End date calculation', {
