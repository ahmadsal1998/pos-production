...
async function determineDatabaseForStore(StoreModel) {
  ...
  console.log(`\u{1F4CA} Assigning store ${totalStores + 1} to database ${finalDatabaseId}`);
...
async function initializeAllDatabases() {
  console.log("\u{1F504} Initializing all database connections (lazy loading recommended instead)...");
...
async function closeAllDatabases() {
  console.log("\u{1F504} Closing all database connections...");
