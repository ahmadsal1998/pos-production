...
__export(warehouseModel_exports, {
  ...
  getWarehouseModel: () => getWarehouseModel,
...
async function getWarehouseModel(prefix, databaseId) {
  if (!prefix) {
    ...
    return import_mongoose.default.model(defaultCollectionName, warehouseSchema, defaultCollectionName);
  }
  ...
  return connection.model(collectionName, warehouseSchema, collectionName);
}
