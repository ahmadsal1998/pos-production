...
const customerModel_1 = require("../utils/customerModel");
...
exports.createCustomer = (0, error_middleware_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        const Customer = await (0, customerModel_1.getCustomerModelForStore)(storeId);
        ...
        if (previousBalance && previousBalance !== 0) {
            try {
                ...
                logger_1.log.error('Error creating initial balance payment record', paymentError);
        ...
        logger_1.log.error('Error creating customer', error);
...
exports.getCustomers = (0, error_middleware_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        logger_1.log.error('Error fetching customers', error);
        return res.status(500).json({
            success: false,
...
exports.getCustomerById = (0, error_middleware_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        logger_1.log.error('Error fetching customer', error);
        return res.status(500).json({
            success: false,
...
exports.updateCustomer = (0, error_middleware_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        // Update customer
        const updatedCustomer = await Customer.findOneAndUpdate({ _id: id, storeId: normalizedStoreId }, updateData, { new: true, runValidators: true });
        if (!updatedCustomer) {
            return res.status(404).json({
                success: false,
                message: 'Customer not found',
        ...
        logger_1.log.error('Error updating customer', error);
        // Handle specific mongoose errors
        if (error.name === 'ValidationError') {
            const errorMessages = Object.values(error.errors || {}).map((e) => e.message);
            return res.status(400).json({
...
exports.deleteCustomer = (0, error_middleware_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        logger_1.log.error('Error deleting customer', error);
        return res.status(500).json({
            success: false,
...
exports.createCustomerPayment = (0, error_middleware_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        logger_1.log.error('Error creating customer payment', error);
        // Handle specific mongoose errors
        if (error.name === 'ValidationError') {
            const errorMessages = Object.values(error.errors || {}).map((e) => e.message);
            return res.status(400).json({
...
exports.getCustomerPayments = (0, error_middleware_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        logger_1.log.error('Error fetching customer payments', error);
        return res.status(500).json({
            success: false,
