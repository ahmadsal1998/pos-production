...
const createWarehouse = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      import_logger.log.error("Create Warehouse - Error getting Warehouse model", {
    ...
    import_logger.log.error("Create Warehouse - Error", {
...
const getWarehouses = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  try {
    ...
    import_logger.log.error("Error fetching warehouses", error);
    return res.status(500).json({
      success: false,
...
const getWarehouseById = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  try {
    ...
    import_logger.log.error("Error fetching warehouse", error);
    return res.status(500).json({
      success: false,
...
const updateWarehouse = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  try {
    ...
    import_logger.log.error("Error updating warehouse", error);
    if (error.name === "ValidationError") {
      const errorMessages = Object.values(error.errors || {}).map((e) => e.message);
      return res.status(400).json({
        success: false,
...
const deleteWarehouse = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  try {
    ...
    import_logger.log.error("Error deleting warehouse", error);
    return res.status(500).json({
      success: false,
...
const exportWarehouses = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  try {
    ...
    import_logger.log.error("Error exporting warehouses", error);
    return res.status(500).json({
      success: false,
...
const importWarehouses = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  try {
    ...
    import_logger.log.error("Error importing warehouses", error);
    return res.status(500).json({
      success: false,
