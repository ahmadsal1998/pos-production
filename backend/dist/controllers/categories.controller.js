...
var import_categoryModel = require("../utils/categoryModel");
...
const createCategory = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  console.log("\u{1F50D} Create Category - User info from token:", {
  ...
  try {
    console.log("\u{1F50D} Create Category - Getting Category model for storeId:", storeId);
    let Category;
    try {
      Category = await (0, import_categoryModel.getCategoryModelForStore)(storeId);
...
const getCategories = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  try {
    const Category = await (0, import_categoryModel.getCategoryModelForStore)(storeId);
...
const importCategories = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  let CategoryModel;
  try {
    CategoryModel = await (0, import_categoryModel.getCategoryModelForStore)(storeId);
  } catch (error) {
    return res.status(400).json({
      success: false,
