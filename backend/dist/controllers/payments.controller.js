...
const processPayment = (0, import_error.asyncHandler)(async (req, res, next) => {
  try {
...
const getPayment = (0, import_error.asyncHandler)(async (req, res, next) => {
  try {
    const { id } = req.params;
    const storeId = req.user?.storeId || null;
...
const getPaymentsByInvoice = (0, import_error.asyncHandler)(async (req, res, next) => {
  try {
...
const cancelPayment = (0, import_error.asyncHandler)(async (req, res, next) => {
  try {
    const { id } = req.params;
    const storeId = req.user?.storeId || null;
    const payment = await import_Payment.Payment.findOne({
