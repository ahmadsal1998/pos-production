...
exports.getProducts = (0, error_middleware_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        let totalProducts = 0;
        try {
            totalProducts = await Product_1.default.countDocuments(queryFilter);
        }
        catch (countError) {
        ...
        let products = [];
        try {
            let query = Product_1.default.find(queryFilter);
...
exports.updateProduct = (0, error_middleware_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        const oldProduct = await Product_1.default.findOne({
            _id: id,
            storeId: storeId.toLowerCase(),
        }).lean();
        // Use unified model with storeId filter for isolation
        const product = await Product_1.default.findOneAndUpdate({ _id: id, storeId: storeId.toLowerCase() }, updateData, { new: true, runValidators: true });
        if (!product) {
            return res.status(404).json({
                success: false,
                message: 'Product not found',
...
exports.deleteProduct = (0, error_middleware_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        // Delete product
        await Product_1.default.deleteOne({ _id: id, storeId: storeId.toLowerCase() });
        // Invalidate cache
        if (barcode) {
...
exports.importProducts = (0, error_middleware_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        const existingBarcodes = await Product_1.default.find({
            storeId: storeId.toLowerCase(),
        ...
        const insertedProducts = await Product_1.default.insertMany(productsToImport, {
