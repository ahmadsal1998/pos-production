...
const getProduct = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  try {
    ...
    import_logger.log.error("Error fetching product", error);
    return res.status(500).json({
      success: false,
...
const updateProduct = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  try {
    ...
    import_logger.log.error("Error updating product", error);
    return res.status(500).json({
      success: false,
...
const deleteProduct = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  try {
    ...
    import_logger.log.error("Error deleting product", error);
    return res.status(500).json({
      success: false,
...
const getProductMetrics = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  try {
    ...
    import_logger.log.error("Error fetching product metrics", error);
    return res.status(500).json({
      success: false,
...
const getProductByBarcode = (0, import_error.asyncHandler)(async (req, res) => {
  ...
  try {
    ...
    import_logger.log.error("Error fetching product by barcode", error);
    return res.status(500).json({
      success: false,
