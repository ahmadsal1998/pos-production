...
router.get("/points-settings", import_admin.getPointsSettings);
router.put("/points-settings", import_admin.validatePointsSettings, import_admin.updatePointsSettings);
