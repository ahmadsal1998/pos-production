...
const sequenceSchema = new import_mongoose.Schema(
  {
    storeId: {
      type: String,
      required: true,
...
const Sequence = import_mongoose.default.models.Sequence || import_mongoose.default.model("Sequence", sequenceSchema);
