...
var import_points = __toESM(require("./routes/points.routes"));
var import_storeAccount = __toESM(require("./routes/storeAccount.routes"));
var import_storePointsAccount = __toESM(require("./routes/storePointsAccount.routes"));
...
app.use("/api/points", import_points.default);
app.use("/api/store-accounts", import_storeAccount.default);
app.use("/api/store-points-accounts", import_storePointsAccount.default);
app.use((req, res) => {
